...
def run_test_factorial():
    ...
    answer_from_oracle = math.factorial(34)
    answer_from_my_code = factorial(34)
    print('Test 4 expected (from oracle):', answer_from_oracle)
    print('       actual (from my code): ', answer_from_my_code)

    answer_from_by_hand = 720
...
def run_test_count_cosines_from():
    ...
    expected = 0
    answer = count_cosines_from(9, 9, 0.7)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    expected = 2
    answer = count_cosines_from(5, 8, 0.6)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    expected = 2
    answer = count_cosines_from(6, 7, -0.3)
